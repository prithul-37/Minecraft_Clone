...
public:
    ...
    void setPlayerPos(glm::vec3 position = glm::vec3(0.0f, 0.0f, 1.0f)) {
        Position = position;
        playerMode = true;
    }


    glm::vec3 ProcessMouseClick() {



        glm::vec3 pointB = Position + glm::normalize(Front) * distance;
        return pointB;

    }

    glm::vec3 ProcessMouseClick1() {


        float dis = 1.0f;
        glm::vec3 pointB = Position + glm::normalize(Front) * dis;
        return pointB;
